              ...
              <View style={styles.labelWithHelp}>
                ...
                <Animated.View style={{ opacity: helpIconBlinkAnim }}>
                  <TouchableOpacity
                    onPress={() => showHelpModal(
                      "FAR Calculator",
                      "Your Final Average Remuneration (FAR) is calculated by entering 36 months of Pensionable Remuneration (PR). You can find your PR values on your monthly payslips—fill in all 36 boxes for a reliable estimate. Enter your highest PR for 36 consecutive months within the 5 years before your retirement date. The calculator automatically uses these 36 months to generate your FAR, which determines your lifetime pension. If retirement is still several years away, you may enter approximate values. For example, if your current PR is $150,000, you can project an average 5 % annual growth (around $7,500 per year) to reflect normal step increases and inflation. Keep in mind that your future PR may vary depending on pay raises, promotions, or salary scale changes."
                    )}
                    style={styles.helpButtonInline}
                  >
                    <HelpCircle size={20} color="#F97316" />
