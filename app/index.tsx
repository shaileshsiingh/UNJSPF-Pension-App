...
//         {/* App at a Glance Section - Single container, single color */}
//         <LinearGradient
//           colors={['#fefefe', '#f9fafb', '#fefefe']}
//           start={{ x: 0, y: 0 }}
//           end={{ x: 1, y: 1 }}
...
//               start={{ x: 0, y: 0 }}
//               end={{ x: 1, y: 1 }}
//               style={styles.singleFeatureContainer}
//             >
//               <View style={styles.featuresHorizontalContainer}>
//                 <View style={styles.featureSection}>
//                   <Text style={styles.glanceIcon}>📊</Text>
//                   <Text style={styles.glanceTitle}>UNJSPF Benefits</Text>
//                   <Text style={styles.featureText}>Prep Checklist {'\n'}• Pension Calculator {'\n'}• Options</Text>
//                 </View>
//                 <View style={styles.featureSection}>
//                   <Text style={styles.glanceIcon}>✈️</Text>
//                   <Text style={styles.glanceTitle}>Employer Benefits</Text>
//                   <Text style={styles.featureText}>HR Entitlements {'\n'}• Calculator {'\n'}• Actions {'\n'}• Timelines</Text>
//                 </View>
//                 <View style={styles.featureSection}>
//                   <Text style={styles.glanceIcon}>👥</Text>
//                   <Text style={styles.glanceTitle}>Post-Retirement</Text>
//                   <Text style={styles.featureText}>Best country to Retire {'\n'}• Pursue your passion with AI {'\n'}• Easy Travel {'\n'}• And many more.</Text>
//                 </View>
//               </View>
//             </LinearGradient>
//           </View>
...
//         {/* UNJSPF Overview Section - Updated with single containers */}
//         <LinearGradient
//           colors={['#fefefe', '#f8fafc', '#fefefe']}
//           start={{ x: 0, y: 0 }}
//           end={{ x: 1, y: 1 }}
...
//           {/* Financials - Combined in single container */}
//           <Text style={styles.categoryTitle}>Financials</Text>
//           <LinearGradient
//             colors={['#dbeafe', '#bfdbfe', '#93c5fd']}
//             start={{ x: 0, y: 0 }}
//             end={{ x: 1, y: 1 }}
//             style={styles.combinedStatContainer1}
//           >
...
//           {/* Membership - Combined in single container with different color */}
//           <Text style={[styles.categoryTitle, styles.membershipTitle]}>Membership</Text>
//           <LinearGradient
//             colors={['#fef3c7', '#fde68a', '#f59e0b']}
//             start={{ x: 0, y: 0 }}
//             end={{ x: 1, y: 1 }}
//             style={styles.combinedStatContainer}
//           >
//             <View style={styles.statItem}>
//               <Text style={styles.statIcon}>🏢</Text>
//               <Text style={styles.statValue2}>25</Text>
...
//           {/* About the Fund - Single canvas for all points */}
//           <LinearGradient
//             colors={['#fefefe', '#f8fafc', '#f1f5f9']}
//             start={{ x: 0, y: 0 }}
//             end={{ x: 1, y: 1 }}
//             style={styles.aboutSingleContainer}
//           >
//             <Text style={styles.aboutText}>• Established in 1949 by the General Assembly, UNJSPF is a defined benefit plan providing retirement, death, disability, and related benefits.</Text>
//             <Text style={styles.aboutText}>• The Fund currently pays out an average of $40,000 per pensioner annually to over 89,000 pensioners.</Text>
//             <Text style={styles.aboutText}>• In its 75-year history, the Fund has never missed a pension payment and has adequate resources to meet obligations in the next 30-40 years.</Text>
//             <Text style={styles.aboutText}>• UN retirees, typically aged 60-65, have an average post-retirement life expectancy of about 24–28 years at the time of retirement.</Text>
//             <Text style={styles.aboutText}>• Your age, contributory service, and salary grade/step determine your pension value.</Text>
//             <Text style={styles.aboutText}>• You can receive your pension in your home country's currency.</Text>
//             <Text style={styles.aboutText}>• Your pension is adjusted based on cost of living and paid for life.</Text>
//             <Text style={styles.aboutText}>• After death, benefits transfer to your dependent spouse or eligible survivors.</Text>
//             <Text style={styles.aboutText}>• You can separate at any time you want.</Text>
//             <Text style={styles.aboutText}>• Your pension is managed by a globally trusted institution.</Text>
...
//   // App at a Glance Section - Updated styles
//   appGlanceSection: {
//     paddingVertical: 0,
//     paddingHorizontal: getHorizontalPadding(),
//     backgroundColor: 'transparent',
...
//     borderRadius: scaleSize(16, 18, 20),
//     padding: scaleSize(16, 18, 20),
//     shadowColor: '#000',
//     shadowOffset: { width: 0, height: 4 },
//     shadowOpacity: 0.1,
//     shadowRadius: 8,
...
//   // UNJSPF Overview Section - Updated with combined containers
//   overviewSection: {
//     paddingVertical: 0,
//     paddingHorizontal: getHorizontalPadding(),
//     backgroundColor: 'transparent',
...
//   // Combined Stat Containers
//   combinedStatContainer: {
//     flexDirection: 'row',
...
//     borderWidth: 1,
//     borderColor: 'rgba(255, 255, 255, 0.8)',
//     marginHorizontal: scaleSize(8, 10, 12),
//   },
//   combinedStatContainer1: {
//     flexDirection: 'row',
//     justifyContent: 'center',
//     alignItems: 'center',
//     borderRadius: scaleSize(16, 18, 20),
...
//     borderWidth: 1,
//     borderColor: 'rgba(255, 255, 255, 0.8)',
//     marginHorizontal: scaleSize(30, 40, 50),
//     maxWidth: scaleSize(392, 448, 504),
//     width:230,
//     alignSelf: 'center',
//     gap: scaleSize(20, 25, 30),
//   },
//   statItem: {
//     alignItems: 'center',
//     flex: 1,
...
//     fontSize: scaleFont(12, 13, 14),
//     color: '#374151',
//     lineHeight: scaleFont(18, 19, 20),
//     fontFamily: getRobotoFont('regular'),
//     textAlign: 'justify',
//     marginBottom: scaleSize(6, 7, 8),
//   },
//   sourceText: {
//     textAlign: 'center',
//     fontStyle: 'italic',
//     fontSize: scaleFont(8, 9, 10),
//     color: 'rgb(50 50 61)',
//     marginTop: scaleSize(8, 10, 12),
//     fontFamily: getRobotoFont('regular'),
//   },
